...
async function checktrainertrainpubdb(trainernamenya, classtitlenya, trainobjnya, trainpernya, 
...
trainingperiod: 1, trainingsyllabus: 1, labsyllabus: 1, _id: 0});
   if(exists !== null){
     return exists;
}      
...
module.exports = {checktrainertrainpubdb};
